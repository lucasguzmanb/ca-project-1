...
TEST(utest_imgaos, ResizeAndCompare) {
  ...
  std::vector<TestCase> const testCases = {
    {.inputFile  = "input/deer-large.ppm",
     .outputFile = "outputs/resize/deer-large-100.ppm",
     .newWidth   = 100,
     .newHeight  = 100 },
    {.inputFile  = "input/deer-large.ppm",
     .outputFile = "outputs/resize/deer-large-1000.ppm",
     .newWidth   = 1000,
     .newHeight  = 1000},
    {.inputFile  = "input/deer-small.ppm",
     .outputFile = "outputs/resize/deer-small-100.ppm",
     .newWidth   = 100,
     .newHeight  = 100 },
    {.inputFile  = "input/deer-small.ppm",
     .outputFile = "outputs/resize/deer-small-1000.ppm",
     .newWidth   = 1000,
     .newHeight  = 1000},
    {.inputFile  = "input/lake-large.ppm",
     .outputFile = "outputs/resize/lake-large-100.ppm",
     .newWidth   = 100,
     .newHeight  = 100 },
    {.inputFile  = "input/lake-large.ppm",
     .outputFile = "outputs/resize/lake-large-1000.ppm",
     .newWidth   = 1000,
     .newHeight  = 1000},
    {.inputFile  = "input/lake-small.ppm",
     .outputFile = "outputs/resize/lake-small-100.ppm",
     .newWidth   = 100,
     .newHeight  = 100 },
    {.inputFile  = "input/lake-small.ppm",
     .outputFile = "outputs/resize/lake-small-1000.ppm",
     .newWidth   = 1000,
     .newHeight  = 1000}
  };
