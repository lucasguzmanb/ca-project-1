...
template ImageSOA<uint8_t> resize(ImageSOA<uint8_t> pixels, Metadata metadata, std::vector<int> size);
template ImageSOA<uint16_t> resize(ImageSOA<uint16_t> pixels, Metadata metadata, std::vector<int> size);